...
The emulated machine is an IBM 1620 Model 1 in its base configuration with 20,000 decimal digits of memory and no special features (such as divide instructions, indirect or indexed addressing, or floating point instructions). The addition and multiplication tables in 1620 memory are not used but standard Python integer math.
